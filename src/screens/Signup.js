...
const Signup = () => {
    ...
    const signUp = async () => {
        ...
        try {
            ...
            // Here you could add additional code to save user details in Firestore or Realtime Database if needed.
            // For example, saving name and username to Firestore:
            // const userRef = firestore.collection('users').doc(response.user.uid);
            // await userRef.set({ name, username, email });
